...
#define configTICK_RATE_HZ				( ( portTickType ) 1000 )  // 1000 )  ws
#define configMAX_PRIORITIES			( ( unsigned portBASE_TYPE ) 16 ) // 8 )  ws
#define configMINIMAL_STACK_SIZE		( ( unsigned short ) 128 )
#define configTOTAL_HEAP_SIZE			( ( size_t ) ( 8*1024 ) )   // ( 16*1024 ) )
...
// ws add: high-speed tick (std. 20 kHz)
